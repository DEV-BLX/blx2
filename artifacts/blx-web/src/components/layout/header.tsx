    ...
    <header className="sticky top-0 z-50 w-full glass-header">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5">
        ...
        <nav className="hidden lg:flex items-center gap-0.5">
          ...
          <button
            onClick={toggleTheme}
            className="flex h-9 w-9 items-center justify-center rounded-xl text-white/50 hover:text-gold hover:bg-white/8 transition-all duration-200"
          ...
          {!user ? (
            ...
            <button
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-[13px] font-medium text-white/60 hover:text-white/90 hover:bg-white/8 transition-all ml-1"
              onClick={logout}
            >
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <button
            onClick={toggleTheme}
            className="flex h-10 w-10 items-center justify-center rounded-xl text-white/50 hover:text-gold hover:bg-white/8 transition-all"
            aria-label="Toggle dark mode"
          >
