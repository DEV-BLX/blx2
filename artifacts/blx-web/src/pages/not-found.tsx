  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] neu-page-bg flex items-center justify-center px-4">
      <div className="text-center">
        <h1 className="text-7xl font-bold bg-gradient-to-b from-navy to-navy/40 dark:from-gold dark:to-gold/40 bg-clip-text text-transparent mb-3">404</h1>
        <p className="text-lg text-coffee-brown/60 dark:text-white/45 font-light mb-8">Page not found</p>
        <Link href="/">
